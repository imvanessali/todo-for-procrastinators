...
(async function () {
  ...
  const ICON_ARCHIVE = '<svg viewBox="0 0 24 24" fill="currentColor" width="15" height="15"><path d="M3 4 H21 A1 1 0 0 1 22 5 V7 A1 1 0 0 1 21 8 H3 A1 1 0 0 1 2 7 V5 A1 1 0 0 1 3 4 Z"/><path fill-rule="evenodd" d="M4 9 H20 V19 A2 2 0 0 1 18 21 H6 A2 2 0 0 1 4 19 Z M11 11 H13 V14 H15 L12 17 L9 14 H11 Z"/></svg>';
