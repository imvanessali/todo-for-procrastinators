...
(async function () {
  ...
  const ICON_ARCHIVE = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><path d="M4 7.5 L6.2 4 H17.8 L20 7.5 H4 Z"/><path d="M5 7.5 V19 a1 1 0 0 0 1 1 H18 a1 1 0 0 0 1 -1 V7.5"/><path d="M12 10.5 V16"/><path d="M9.3 13.3 L12 16 L14.7 13.3"/></svg>';
